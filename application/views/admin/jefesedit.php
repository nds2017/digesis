			...
			<table class="table table-bordered table-striped">
				<tr>
					<td>Nombres : </td><td><input pattern="[A-Za-z]{1,30}" title="Solo Letras" type="text" required maxlength="30" autofocus="autofocus" name="nombres" value="<?=@$data->nombres?>"></td>
				</tr>
				<tr>
					<td>Apellidos : </td><td><input pattern="[A-Za-z]{1,30}" title="Solo Letras" type="text" required maxlength="30" name="apellidos" value="<?=@$data->apellidos?>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Usuario : </td><td><input <?=(@$data->id)?'disabled':''?> required type="text" name="user" value="<?=@$data->user?>"></td>
				</tr>
				<tr>
					<td>Contraseña : </td><td><input required type="password" name="password" value="<?=@$data->password?>"></td>
				</tr>
				<?php if ( @$data->id ) { ?>
				<tr><td>Estado : </td>
					<td>
